...
namespace Planner
{
    public partial class MainWindow : Window
    {
        ...
        private void FoldersListView_PreviewKeyDown(object sender, KeyEventArgs e) 
        {
            e.Handled = true;
        }

        private void RightColumn_SourceUpdated(object sender, System.Windows.Data.DataTransferEventArgs e)
        {
